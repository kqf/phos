...
void PhotonSelection::FillHistograms(TObjArray * clusArray, TList * pool, const EventFlags & eflags)
{
...
//________________________________________________________________
void PhotonSelection::SelectTwoParticleCombinations(const TObjArray & photonCandidates, const EventFlags & flags)
{
