...
void AddAnalysisTaskPP(UInt_t offlineTriggerMask, TString description, TString suff = "", TString badmap = "")
{
	...
	mc_weights1.fW0 = 1.490487117730805;
	mc_weights1.fW1 = 0.15303013222262335;
	mc_weights1.fW2 = 8.241894695494016;
	...
	mc_weights_only1.fW0 = 1.490487117730805;
	mc_weights_only1.fW1 = 0.15303013222262335;
	mc_weights_only1.fW2 = 8.241894695494016;
	...
	mc_weights2.fNonSigma = 1.0644033741013799 * 0.5;

	mc_weights_only2.fNonGlobal = 1.0;
	mc_weights_only2.fNonA = 0.0;
	mc_weights_only2.fW0 = 1.490487117730805;
	mc_weights_only2.fW1 = 0.15303013222262335;
	mc_weights_only2.fW2 = 8.241894695494016;
	...
	mc_weights3.fNonSigma = 1.0644033741013799 * 1.5;
