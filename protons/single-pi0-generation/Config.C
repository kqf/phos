...
static Double_t            beamEnergy = 7000.;
//!!!
...
//     TF1*   ptSpectrum = (TF1*)fpp->Get("ts0");
	TF1* ptSpectrum = new TF1("ptSpectrum", "1.0", 0, 50.);
...
//     Pion transverse momentum
	...
	/*
	  ...
	  AliGenEMCocktailV2 *gener =
			  AddMCEMCocktailV2(200,1,0,1,"pp_7TeV.root","7TeV_PCM",100,0.,20.,2000,0,1);


	  gener->SetYRange(-0.15,0.15);
	  gener->SetPhiRange(240.,340.) ;
	  gener->SetWeightingMode(kNonAnalog);
