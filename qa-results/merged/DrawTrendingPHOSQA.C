void DrawTrendingPHOSQA(TString mergedTrendFile = "trending.root")
{
  ...
  const char * cut = ttree->GetTitle();
  cout << cut << endl;

  // booking histograms
  TH1F* havCluEnergySM1 = new TH1F("havCluEnergySM1",Form("Average cluster energy %s in Module 4", cut),nRuns,0.,nRuns);
  TH1F* havCluEnergySM2 = new TH1F("havCluEnergySM2",Form("Average cluster energy %s in Module 3", cut),nRuns,0.,nRuns);
  TH1F* havCluEnergySM3 = new TH1F("havCluEnergySM3",Form("Average cluster energy %s in Module 2", cut),nRuns,0.,nRuns);
  TH1F* havCluEnergySM4 = new TH1F("havCluEnergySM4",Form("Average cluster energy %s in Module 1", cut),nRuns,0.,nRuns);

  TH1F* havCluMultSM1 = new TH1F("havCluMultSM1",Form("Average number of clusters per event %s in Module 4", cut),nRuns,0.,nRuns);
  TH1F* havCluMultSM2 = new TH1F("havCluMultSM2",Form("Average number of clusters per event %s in Module 3", cut),nRuns,0.,nRuns);
  TH1F* havCluMultSM3 = new TH1F("havCluMultSM3",Form("Average number of clusters per event %s in Module 2", cut),nRuns,0.,nRuns);
  TH1F* havCluMultSM4 = new TH1F("havCluMultSM4",Form("Average number of clusters per event %s in Module 1", cut),nRuns,0.,nRuns);

  TH1F* havNcellPerCluSM1 = new TH1F("havNcellPerCluSM1",Form("Average number of cells in cluster %s in Module 4", cut),nRuns,0.,nRuns);
  TH1F* havNcellPerCluSM2 = new TH1F("havNcellPerCluSM2",Form("Average number of cells in cluster %s in Module 3", cut),nRuns,0.,nRuns);
  TH1F* havNcellPerCluSM3 = new TH1F("havNcellPerCluSM3",Form("Average number of cells in cluster %s in Module 2", cut),nRuns,0.,nRuns);
  TH1F* havNcellPerCluSM4 = new TH1F("havNcellPerCluSM4",Form("Average number of cells in cluster %s in Module 1", cut),nRuns,0.,nRuns);
